...
public class QuizManager : MonoBehaviour
{
    ...
    public float quizDuration = 10f; // 10초 동안 퀴즈 제한 시간
    ...
    private float playerSpeed = 5f; // 플레이어 이동 속도, PlayerController.cs 기준
